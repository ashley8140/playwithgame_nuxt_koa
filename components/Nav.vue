  ...
  <div class="nav_wrap" id="nav" ref="nav">
    <div class="container nav">
      ...
      <ul class="nav_links fl">
        ...
        <nuxt-link v-if="!access_token" exact to>
          <li class="nav_item center" @click="register">
            <span>登录 | 注册</span>
          </li>
        </nuxt-link>
      </ul>
      ...
      >
        ...
        <div v-if="userInfo.stype==0">
          <ul class="links">
            ...
            <nuxt-link :to="{path:'/userCenter/join'}" tag="li" class="item">
              <img
